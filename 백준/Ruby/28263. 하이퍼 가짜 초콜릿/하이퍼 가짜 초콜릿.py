...
#             print('WRONG!!!')
if __name__=='__main__':
    print(*[11289601, 12757501, 13305601, 17860501, 18480001, 20697601, 31752001, 39916801, 72576001, 82790401, 88704001])